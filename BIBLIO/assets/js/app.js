...
var zone4 = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
       var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>NOM</th><td>" + feature.properties.Nom + "</td></tr>"  +  '<img src="'+ feature.properties.photo +'" style="width:300px;height:300px;">'    +"<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/CDC.geojson", function (data) {
  zone4.addData(data);
});
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/map1.png' width='24' height='28'>&nbsp;CDC": zone4Layer

   
     
  },
  "Reference": {
    "Limite du CDC": boroughs
